...
61 : 0853160000020000000000000010012015012818300571116801234567890000005586000000000000000001*/
        ...
        public void Test05Parse0110()
        {
            string message =
              ...
              "129082288880110722000010AC00000160000000000000000990174000000000055012818300555555510st000000015028185555550000000001000000022555003";
...
42 : 000000022555003
        ...
        {
            string msg = @"101082288880302E2240000080000000000002000000000160000000000000000990176012818000777777715125028187777771";
            MsgContext msgContextMain = this.mainMsgWorker.Parse(msg);
        ...
        public void Test08Build0302()
        {
            ...
            string expected = @"101082288880302E2240000080000000000002000000000160000000000000000990176012818000777777715125028187777771";
            string fromTo = "08228888";
            string mti = "0302";
            //
...
91 : 1
        ...
        {
            string expected = @"212888808220420F220000108C000080000004000000000160000000000000000990174000000000055012818000666666610st00000001502818666666000000010000000225550030240080000000000000000000000100012818300555555500000001502818666666  ";
            string fromTo = "88880822";
            string mti = "0420";
            //
            string[] srcList = new string[129];
...
90 : 0100 0128183005 555555 10st00000001  
        ...
        {
            string msg = @"212888808220420F220000108C000080000004000000000160000000000000000990174000000000055012818000666666610st00000001502818666666000000010000000225550030240080000000000000000000000100012818300555555500000001502818666666  ";
        ...
        public void Test13Buid0430()
        {
            string expected = //@"187082288880420F220000108C000080000004000000000160000000000000000990174000000000055012818000666666610st00000001502818666666000000010000000225550030240080000000000000000000000100012818300555555500000001502818666666  ";
                                @"187082288880430F22000010AC000000000004000000000160000000000000000990174000000000055012818000666666610st0000000150281866666600000000010000000225550030100012818300555555500000001502818666666  ";
            string fromTo = "08228888";
            string mti = "0430";
            //
            string[] srcList = new string[129];
...
90 : 0100012818300555555500000001502818666666  "   
        ...
        public void Test14Parse0430()
        {
            string msg = //@"187082288880430F22000010AC000000000004000000000160000000000000000990174000000000055012818000666666610st0000000150281866666600000000010000000225550030100012818300555555500000001502818666666  ";
                         @"119888808220312622400000A0000081600000000000000009901760128180007777777151250281877777700030010000000000000020150128180007"; 
            MsgContext msgContextMain = this.mainMsgWorker.Parse(msg);
...
61 : 030010000000000000020150128180007            
        ...
        {
            MsgContext msgContextMain = null;
            string msg = @"135888808220312E22400000A00000800000000000000001600000000000000009901760128180007777777151250281877777700030010000000000000020150128180007";
        ...
        {
            MsgContext msgContextMain = null;
            string msg = "063082288880800822000000000000004000000000000000128132501111111071";
            msgContextMain = this.mainMsgWorker.Parse(msg);
        ...
        public void Test22BuildSignOnResponse()
        {
            ...
            string expected = //@"082288880800822000000000000004000000000000000128132501111111071";
                "063888808220810822000000000000004000000000000000128132501111111071";
            string fromTo = "88880822";
            string mti = "0810";
        ...
        {
            MsgContext msgContextMain = null;
            string msg = "063082288880800822000000000000004000000000000000128132502222222072";
            msgContextMain = this.mainMsgWorker.Parse(msg);
        ...
        {
            MsgContext msgContextMain = null;
            string expected = @"063888808220810822000000000000004000000000000000128132502222222072";
            string fromTo = "88880822";
            string mti = "0810";
            string[] srcList = new string[129];
            //07 : 0128132502
        ...
        {
            MsgContext msgContextMain = null;
            string msg = "063082288880800822000000000000004000000000000000128132503333333301";
            msgContextMain = this.mainMsgWorker.Parse(msg);
        ...
        {
            MsgContext msgContextMain = null;
            string expected = @"06588880822081082200000020000000400000000000000012813250333333300301";
            string fromTo = "88880822";
            string mti = "0810";
            string[] srcList = new string[129];
            //07 : 0128132503
        ...
        {
            MsgContext msgContextMain = null;
            string msg = "06508228888081082200000020000000400000000000000012813250333333300301";
            msgContextMain = this.mainMsgWorker.Parse(msg);
        ...
        {
            MsgContext msgContextMain = null;
            string expected = @"063888808220800822000000000000004000000000000000128132503333333301";
            string fromTo = "88880822";
            string mti = "0800";
            string[] srcList = new string[129];
            srcList[7] = "0128132503";
